...
While private corporations frequently contract state shipyards to manufacture existing public blueprints, high-capital corporate syndicates possess the economic autonomy to design their own **Proprietary Corporate Blueprints** to fulfill specific, localized market needs:
...
*   **Proprietary fleet locks:** These corporate-designed ships are marked as private corporate IP. The state cannot naturally manufacture these specific hulls for military operations unless they forcefully pass **Eminent Domain Laws** or execute nationalization mandates, which drops corporate trust variables across that star sector.
...
$$Maximum Launch Mass = Hull Frame Mass + \sum Module Dry Masses + Max Cargo Capacity Weight$$

$$Required Minimum Thrust = Maximum Launch Mass \times Imperial Home Planet Gravity \times \left( 1.0 + Atmospheric Pressure \right)$$
