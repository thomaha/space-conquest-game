...
- Only capitalize the first letter of a heading, title, or sentence, plus proper nouns, acronyms, or specific technical terms (e.g., `JSON`, `UI`, `FXGL`, `ID`, `Java`, `Spring Boot`).
