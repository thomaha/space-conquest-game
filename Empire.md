...
### Advanced political accession
The imperial government operates through a dynamic accession loop that reacts to the state of the empire.
*   **Shortage-driven elections:** In democratic societies, citizens vote for ministers and governors based on current material deficits. A planet suffering from a food shortage will naturally favor a `farmer` as its next governor.
*   **Ministerial expertise synergy:** Cabinet positions grant higher efficiency bonuses when the appointed individual's professional background matches the ministry's portfolio (e.g., a `scientist` leading the Ministry of Technology).
*   **Hive mind governance bypass:** Centralized consciousness empires ignore all election and appointment mechanics, maintaining a flat baseline efficiency across all systems.
